...
// 🔒 Read-only toolbar — search + View columns + Sort hai (admin jaisa hi),
// lekin koi bulk delete / revoke / restore nahi hai kyunki normal role user
...
export function DataTableToolbar({ table }) {
    ...
    return (
        <div className="flex py-5 flex-wrap items-center justify-between gap-3">
            ...
            {/* RIGHT SIDE - VIEW + SORT (read-only, no bulk actions) */}
            <div className="flex items-center gap-3">
                {/* VIEW COLUMNS */}
                <Popover modal>
...
//         try {
//             await api.post("/admin/credentials/bulk-delete", {
//                 ids: getIds()
//             });
//             onRefresh();
...
//         try {
//             await api.post("/admin/credentials/bulk-revoke", {
//                 ids: getIds()
//             });
//             onRefresh();
//             table.resetRowSelection();
...
//         try {
//             await api.post("/admin/credentials/bulk-restore", {
//                 ids: getIds()
//             });
//             onRefresh();
//             table.resetRowSelection();
